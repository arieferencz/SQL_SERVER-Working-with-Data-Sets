...
| Exercise | Description |
|---|---|
| [Calculating the historic subtotal purchasing amount for all vendors](https://github.com/arieferencz/SQL_SERVER-Working-with-Data-Sets/blob/main/SQL_SERVER-Working-with-data-sets/Calculate%20total%20sales%20by%20product%20name.md) | Aggregates historical purchasing totals across all vendors |
